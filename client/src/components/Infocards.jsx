...
const InfoCards = () => {
  ...
  const svgX = useTransform(x, xRange, ["-50px", "50px"]);
  const svgY = useTransform(y, yRange, ["-50px", "50px"]);
  ...
  return (
    <>
      <h1 className='font-header text-7xl font-black mb-24 text-secondary-200 dark:text-secondary-50 flex justify-center items-center'>
        Selling Sleep, Seamlessly.
      </h1>
      <div className='p-16 mx-20 my-5 bg-gradient-to-br from-secondary-50 to-primary-100 dark:from-gray-800 dark:to-primary-200 rounded-xl mb-36 flex justify-around items-center'>
        <motion.svg
          style={{
            x: svgX,
            y: svgY,
          ...
          className='absolute w-72 left-24 -mt-[40%]'>
          <defs>
        ...
        <motion.svg
          ...
          viewBox='0 0 100 100'
          xmlns='http://www.w3.org/2000/svg'
          className='absolute w-64 right-12 mt-[48%] z-50 blur-sm'>
          <defs>
        ...
        <div className='grid grid-cols-2 gap-14 mx-24'>
          <motion.div
            style={{ x: cardX, y: cardY, transition: "transform .2s" }}
            transition={{ type: "spring", stiffness: 500, damping: 10 }}
            className='card bg-secondary-50/10 dark:bg-gray-900/30 backdrop-blur-md rounded-xl p-8 transform transition-all ease-in-out duration-500 flex justify-center items-center text-center shadow-2xl'
            variants={cardVariants}
            initial='offscreen'
            whileInView='onscreen'
            viewport={{ once: true }}
            animate={{ boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.2)" }}>
            <h2 className='text-4xl font-bold mb-2 text-secondary-200 dark:text-secondary-50'>
              Your Smart Mattress Sales Assistant
            </h2>
            <p className='text-secondary-200 dark:text-secondary-50/80'>
          ...
          <motion.div
            ...
            <p className='text-secondary-200 dark:text-secondary-50/80'>
              ...
              then analyze your customer{"'s"} preferences and recommend the best
              mattress for them.
            </p>
          </motion.div>
        </div>
