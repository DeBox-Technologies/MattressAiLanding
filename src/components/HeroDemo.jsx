...
const HeroDemo = () => {
  ...
  const handleScroll = () => {
    ...
    if (element) {
      ...
      const threeQuartersScreen = window.innerHeight * 0.001;
    ...
    <div className='font-body 2xl:max-w-screen-2xl mx-auto relative'>
      ...
      <h1 className="my-14 xl:my-14 pb-4 text-center mx-5 lg:mx-0 text-4xl md:text-4.5xl lg:text-7xl font-black text-secondary-200 dark:text-secondary-50 font-header">Revolutionize Your Interactions.</h1>
        ...
        <div className='absolute w-full hidden lg:inline-block'>
          <div className="absolute w-52 top-32 left-14 xl:w-64 xl:top-24 xl:left-14 p-6 bg-primary-200 border border-primary-50/10 rounded-xl shadow-2xl dark:border-gray-700" style={{ transform: `translateY(-${offsetY * 0.9}px) translateX(-${offsetY * 0.9}px) scale(${1 + offsetY * 0.00075})` }}>
              ...
              <a href="#">
                  <h5 className="mb-2 text-lg xl:text-2xl font-semibold tracking-tight text-secondary-50 dark:text-white">Ready for the future of retail?</h5>
              </a>
              <p className="mb-3 font-normal text-secondary-50 text-md xl:text-xl">Sign Up for exclusive early access to MattressAI.</p>
              <a href="http://eepurl.com/isHTp-/" className="text-md xl:text-xl font-black inline-flex items-center text-secondary-50 hover:underline">
                  Join Us
