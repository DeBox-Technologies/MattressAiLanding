  ...
  return (
    <>
      <div className='2xl:max-w-screen-2xl mx-auto relative'>
          ...
          <div className='w-full max-w-xs md:max-w-sm p-4 bg-secondary-50/90 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700'>
            ...
            <ul role='list' className='space-y-5 my-7'>
              ...
              <li className='flex space-x-3 line-through decoration-gray-500'>
                ...
                <span className='text-base font-normal leading-tight text-gray-500'>
                  1 hour setup for branding & inventory
                </span>
              </li>
              <li className='flex space-x-3 line-through decoration-gray-500'>
                <svg
        ...
        <div className='flex justify-center items-center absolute top-0 right-4'>
          <div className='bg-secondary-200/90 border border-gray-200 rounded-full shadow max-w-xs'>
            ...
            <p className='text-center p-4 text-white text-xs mx-6'>
              Enterprise/E-Commerce<br/>
              Contact for details: blake@themattressai.com
            </p>
            </div>
          </div>
        </div>
